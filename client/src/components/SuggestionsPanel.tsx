...
const aiSuggestions: AISuggestion[] = [
  {
    id: 1,
    title: "Turn old jeans into a stylish tote bag",
    category: "Fashion",
    icon: "👜",
  },
  {
    id: 2,
    title: "Transform wine bottles into elegant vases",
    category: "Home Decor",
    icon: "🍷",
  },
  {
    id: 3,
    title: "Create planters from tin cans",
    category: "Garden",
    icon: "🌱",
  },
  {
    id: 4,
    title: "Make coasters from old CDs and DVDs",
    category: "Crafts",
    icon: "💿",
  },
  {
    id: 5,
    title: "Build a bookshelf from wooden crates",
    category: "Furniture",
    icon: "📚",
  },
  {
    id: 6,
    title: "Upcycle t-shirts into cleaning rags",
    category: "Household",
    icon: "🧹",
  },
  {
    id: 7,
    title: "Convert glass jars into storage containers",
    category: "Organization",
    icon: "🫙",
  },
  {
    id: 8,
    title: "Make wall art from cardboard scraps",
    category: "Art",
    icon: "🎨",
  },
  {
    id: 9,
    title: "Create jewelry from bottle caps",
    category: "Accessories",
    icon: "💎",
  },
  {
    id: 10,
    title: "Build bird feeders from plastic bottles",
    category: "Wildlife",
    icon: "🐦",
  },
  {
    id: 11,
    title: "Make a lampshade from old magazines",
    category: "Lighting",
    icon: "💡",
  },
  {
    id: 12,
    title: "Create a rug from fabric scraps",
    category: "Home Decor",
    icon: "🧶",
  },
  {
    id: 13,
    title: "Build a phone stand from paper clips",
    category: "Tech",
    icon: "📱",
  },
  {
    id: 14,
    title: "Make gift boxes from cereal boxes",
    category: "Crafts",
    icon: "🎁",
  },
  {
    id: 15,
    title: "Create a wallet from duct tape",
    category: "Accessories",
    icon: "👛",
  },
];
